...
function Login({onAuthorize}) {
    ...
    return(
        <form className="popup__form popup__form_type_auth" onSubmit={handleSubmit}  noValidate>
            ...
            <input id="email-input"  type="email" onChange={handleDataChange} placeholder="Email" className="popup__input popup__input_type_auth" name="email" required minLength="2" maxLength="30"/>
              <span className="popup__error place-input-error"></span>
              <input id="password-input" onChange={handleDataChange}  type="password" placeholder="Пароль" className="popup__input popup__input_type_auth" name="password" required/>
